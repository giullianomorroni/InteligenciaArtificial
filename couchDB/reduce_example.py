...
couchTests.reduce = function(debug) {
  ...
  function testReducePagination() {
    ...
    result = db.view('test/view1', {group: true, startkey: 402, endkey: 400, endkey_docid: "398", descending: true, inclusive_end: true, foobar: randVal()});
    TEquals(3, result.rows.length);
    TEquals(402, result.rows[0].key);
    TEquals(3, result.rows[0].value);
    TEquals(401, result.rows[1].key);
    ...
    result = db.view('test/view1', {group: true, startkey: 402, endkey: 400, endkey_docid: "399", descending: true, inclusive_end: true, foobar: randVal()});
    TEquals(3, result.rows.length);
    TEquals(402, result.rows[0].key);
    TEquals(3, result.rows[0].value);
    TEquals(401, result.rows[1].key);
    ...
    result = db.view('test/view1', {group: true, startkey: 402, endkey: 400, endkey_docid: "399", descending: true, inclusive_end: false, foobar: randVal()});
    TEquals(3, result.rows.length);
    TEquals(402, result.rows[0].key);
    TEquals(3, result.rows[0].value);
    TEquals(401, result.rows[1].key);
    ...
    result = db.view('test/view1', {group: true, startkey: 402, endkey: 400, endkey_docid: "400", descending: true, inclusive_end: false, foobar: randVal()});
    TEquals(2, result.rows.length);
    TEquals(402, result.rows[0].key);
    TEquals(3, result.rows[0].value);
    TEquals(401, result.rows[1].key);
